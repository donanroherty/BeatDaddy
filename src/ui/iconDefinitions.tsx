...
const iconDefinitions = {
  note: (
    <svg viewBox="0 0 29.44 90">
      <path d="M29.44,0V75.23c0,.1,0,.2,0,.3-.16,4.91-4.38,10.19-10.75,12.86C10.85,91.67,2.74,89.77.55,84.15S2.94,71.3,10.76,68c4.94-2.07,10-2.08,13.59-.39V0Z" />
    </svg>
  ),
  play: (
